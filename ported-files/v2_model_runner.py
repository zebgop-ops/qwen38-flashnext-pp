...
class GPUModelRunner(LoRAModelRunnerMixin):
    ...
    def execute_model(
        ...
        if not dummy_run:
            ...
            # FIX (ours): give the mamba spec-decode ctx the SOURCE
    ...
    def sample_tokens(
        ...
        # (removed 2026-08-29: the experimental 'placeholder-forward verification
        #  gate' from the falsified 0008 hypothesis. It rejected every draft for any
        #  request rescheduled within pp_size sample-steps — at concurrency 1 that is
        #  EVERY step, capping decode at 1 token/step (~30 tok/s instead of ~76+).
        #  The real corruption is fixed by the pooled gathered tables + req-indexed
        #  mamba ctx (patches 0009/0010).)
